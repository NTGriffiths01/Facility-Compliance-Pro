...
app = FastAPI(title="Facility Compliance Pro Backend", openapi_url="/api/openapi.json", docs_url="/api/docs")
...
async def startup_event():
    ...
    try:
        ...
        db_name = parsed.path.strip("/") or "madoc"
...
async def preview(current_user: dict = Depends(get_current_user)):
    return {
        "title": "Facility Compliance Pro",
        "subtitle": "Operational compliance preview",
        "bullets": [
            "Real-time insights",
